...
export class WasmLibrary {
     ...
     */
    get_canonical_element_id(id: string): string | undefined;
    /**
     ...
     */
    get_native_path_info(id: string): NativePathInfo | undefined;
    /**
     ...
     */
    import_library_json(json: string): string[];
    /**
     ...
     */
    move_element_to_index(uuid: string, target_index: number): boolean;
    /**
     ...
     */
    path_preview(points: Float64Array, width: number, corner_radius: number, num_arc_points: number): Float64Array;
    /**
     ...
     */
    restore_cell_ref_to_with_transform_at(parent_cell: string, ref_cell_name: string, transform: Float64Array, repetition: Float64Array | null | undefined, element_index: number): string | undefined;
    /**
     ...
     */
    readonly import_warnings: string[];
}
...
export class WasmRenderer {
     ...
     */
    get_border_segment_count(): number;
    /**
     ...
     */
    set_diagnostics_enabled(enabled: boolean): void;
    /**
     ...
     */
    set_move_preview_delta(dx: number, dy: number): void;
    /**
     * Set the logical elements translated by the transient move uniform.
     */
    set_move_preview_targets(ids: string[]): void;
    /**
...
export interface InitOutput {
    ...
    readonly __wbg_nativepathinfo_free: (a: number, b: number) => void;
    ...
    readonly wasmlibrary_import_library_json: (a: number, b: number, c: number) => [number, number, number, number];
    readonly wasmlibrary_import_warnings: (a: number) => [number, number];
    ...
    readonly wasmrenderer_clear_move_preview: (a: number) => void;
    ...
    readonly wasmrenderer_get_border_segment_count: (a: number) => number;
    ...
    readonly wasmrenderer_get_presented_frame_count: (a: number) => number;
    readonly wasmrenderer_get_render_cpu_time_ms: (a: number) => number;
    readonly wasmrenderer_get_sample_count: (a: number) => number;
    readonly wasmrenderer_get_selection: (a: number) => [number, number];
    readonly wasmrenderer_get_triangle_count: (a: number) => number;
    ...
    readonly wasmrenderer_set_diagnostics_enabled: (a: number, b: number) => void;
    ...
    readonly wasm_bindgen__closure__destroy__h735f4c2543ff1fc8: (a: number, b: number) => void;
    ...
    readonly wasm_bindgen__convert__closures_____invoke__h7a20c8dc0f87b338: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h7a20c8dc0f87b338_2: (a: number, b: number, c: any) => void;
