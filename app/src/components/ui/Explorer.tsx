          ...
          <div className="relative h-5 min-w-0 flex-1">
            {isEditing ? (
              ...
              <button
                ...
                className={cn(
                  "absolute inset-0 truncate border-0 bg-transparent p-0 text-left text-xs leading-5 font-medium text-foreground-secondary select-none focus:outline-none",
