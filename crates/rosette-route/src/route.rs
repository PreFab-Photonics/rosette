...
impl RouteAnnotations {
    ...
    pub fn new(path_length: Option<f64>, bends: Vec<BendInfo>, warnings: Vec<String>) -> Self {
        assert!(
            path_length.is_none_or(f64::is_finite),
            "Route path length must be finite"
        );
        Self {
            path_length,
            bends,
...
impl RouteResult {
    ...
    pub fn into_cell_with_annotations(self, name: &str) -> (Cell, RouteAnnotations) {
        let Self {
            polygons,
            path_length,
            port_in,
...
mod tests {
    ...
    fn test_route_result_owns_layer_and_materialization() {
        ...
        let (cell, annotations) = result.into_cell_with_annotations("result");
