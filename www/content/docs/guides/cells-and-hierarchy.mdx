...
JSON and GDS keep their existing serialized shapes. Import rejects malformed
local model state, while export validates before writing. GDS export also
checks format-specific limits such as coordinate ranges and representable
