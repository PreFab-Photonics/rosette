...
<PyFunction name={"skip_cell"} type={"(name) -> None"}>
...
<PyFunction name={"waive_region"} type={"(name, region) -> None"}>
...
<PyFunction name={"skips"} type={"(name) -> bool"}>
...
<PyFunction name={"waiver_regions"} type={"(name) -> list[BBox]"}>
