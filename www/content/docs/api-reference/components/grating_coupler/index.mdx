...
<PyAttribute name={"__all__"} type={null} value={"['grating_coupler']"} />

<Tabs items={["Functions"]}>

<Tab value={"Functions"}>

<PyFunction name={"grating_coupler"} type={"(layer, waveguide_width=0.5, period=0.63, fill_factor=0.5, num_periods=25, grating_type='uniform', focusing_angle=None, grating_width=12.0, taper_length=20.0) -> Cell"}>
...
<PyParameter name={"period"} type={"float"} value={"0.63"}>

Grating period in microns (default: 0.63 for 1550nm Si)

</PyParameter>
<PyParameter name={"fill_factor"} type={"float"} value={"0.5"}>

Fill factor 0-1 (default: 0.5)

</PyParameter>
<PyParameter name={"num_periods"} type={"int"} value={"25"}>

Number of grating periods

</PyParameter>
<PyParameter name={"grating_type"} type={"Literal['uniform', 'apodized']"} value={"'uniform'"}>

"uniform" or "apodized" (varying fill factor)

</PyParameter>
<PyParameter name={"focusing_angle"} type={"float | None"} value={"None"}>

Angle in degrees for curved teeth (None for straight)

</PyParameter>
<PyParameter name={"grating_width"} type={"float"} value={"12.0"}>

Width of the grating region in microns

</PyParameter>
<PyParameter name={"taper_length"} type={"float"} value={"20.0"}>

Length of the taper from waveguide to grating in microns
...
<PyFunction name={"_create_taper"} type={"(width_in, width_out, length, focusing_angle) -> Polygon"}>
...
<PyParameter name={"width_in"} type={"float"} value={null} />
<PyParameter name={"width_out"} type={"float"} value={null} />
<PyParameter name={"length"} type={"float"} value={null} />
<PyParameter name={"focusing_angle"} type={"float | None"} value={null} />
...
<PyFunction name={"_curved_tooth"} type={"(tooth_width, period_index, focusing_angle_deg, taper_length, period, fill_factor) -> Polygon"}>
...
<PyParameter name={"tooth_width"} type={"float"} value={null} />
<PyParameter name={"period_index"} type={"int"} value={null} />
<PyParameter name={"focusing_angle_deg"} type={"float"} value={null} />
<PyParameter name={"taper_length"} type={"float"} value={null} />
<PyParameter name={"period"} type={"float"} value={null} />
<PyParameter name={"fill_factor"} type={"float"} value={null} />
