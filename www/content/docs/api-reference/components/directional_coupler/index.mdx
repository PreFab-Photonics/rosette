...
in2 (y \< 0) ----//     \---- out2 (y \< 0)
```
<PyAttribute name={"__all__"} type={null} value={"['directional_coupler']"} />

<Tabs items={["Functions"]}>

<Tab value={"Functions"}>

<PyFunction name={"directional_coupler"} type={"(layer, waveguide_width=0.5, coupling_length=20.0, gap=0.2, bend_length=10.0, port_spacing=5.0, num_segments=32) -> Cell"}>
...
<PyParameter name={"coupling_length"} type={"float"} value={"20.0"}>

Length of the parallel coupling region in microns

</PyParameter>
<PyParameter name={"gap"} type={"float"} value={"0.2"}>

Gap between waveguides in coupling region in microns

</PyParameter>
<PyParameter name={"bend_length"} type={"float"} value={"10.0"}>

Length of the S-bend transitions in microns

</PyParameter>
<PyParameter name={"port_spacing"} type={"float"} value={"5.0"}>

Port spacing (center-to-center) at input/output in microns

</PyParameter>
<PyParameter name={"num_segments"} type={"int"} value={"32"}>

Number of polygon segments for S-bends
...
<PyFunction name={"_coupler_arm_polygon"} type={"(bend_length, coupling_length, width, y_port, y_couple, num_segments) -> Polygon"}>
...
<PyParameter name={"bend_length"} type={"float"} value={null} />
<PyParameter name={"coupling_length"} type={"float"} value={null} />
<PyParameter name={"width"} type={"float"} value={null} />
<PyParameter name={"y_port"} type={"float"} value={null} />
<PyParameter name={"y_couple"} type={"float"} value={null} />
