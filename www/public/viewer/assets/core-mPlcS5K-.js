function s(n, r, e, o) {
  if (typeof r == "function" ? n !== r || !o : !r.has(n)) throw new TypeError("Cannot read private member from an object whose class did not declare it");
  return e === "m" ? o : e === "a" ? o.call(n) : o ? o.value : r.get(n);
}
function i(n, r, e, o, _) {
  if (typeof r == "function" ? n !== r || true : !r.has(n)) throw new TypeError("Cannot write private member to an object whose class did not declare it");
  return r.set(n, e), e;
}
var t;
const c = "__TAURI_TO_IPC_KEY__";
function u(n, r = false) {
