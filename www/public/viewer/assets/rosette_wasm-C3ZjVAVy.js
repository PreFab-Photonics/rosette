class j {
  ...
  free() {
    ...
    c.__wbg_cellrefinfo_free(e, 0);
  }
  get cell_name() {
    let e, t;
    try {
      const n = c.cellrefinfo_cell_name(this.__wbg_ptr);
  ...
  get transform() {
    const e = c.cellrefinfo_transform(this.__wbg_ptr);
    var t = S(e[0], e[1]).slice();
    return c.__wbindgen_free(e[0], e[1] * 8, 8), t;
  }
}
...
class z {
  ...
  free() {
    const e = this.__destroy_into_raw();
    c.__wbg_elementinfo_free(e, 0);
  }
  get datatype() {
    return c.elementinfo_datatype(this.__wbg_ptr);
  }
  get layer() {
    return c.elementinfo_layer(this.__wbg_ptr);
  }
  get vertices() {
    const e = c.elementinfo_vertices(this.__wbg_ptr);
    var t = S(e[0], e[1]).slice();
    return c.__wbindgen_free(e[0], e[1] * 8, 8), t;
  }
}
...
class P {
  ...
  free() {
    const e = this.__destroy_into_raw();
    c.__wbg_wasmlibrary_free(e, 0);
  }
  active_cell_name() {
    const e = c.wasmlibrary_active_cell_name(this.__wbg_ptr);
    let t;
    return e[0] !== 0 && (t = m(e[0], e[1]).slice(), c.__wbindgen_free(e[0], e[1] * 1, 1)), t;
  }
  add_cell(e) {
    const t = g(e, c.__wbindgen_malloc, c.__wbindgen_realloc), n = b, r = c.wasmlibrary_add_cell(this.__wbg_ptr, t, n);
    if (r[1]) throw v(r[0]);
  }
  add_cell_ref(e, t, n) {
    const r = g(e, c.__wbindgen_malloc, c.__wbindgen_realloc), _ = b, o = c.wasmlibrary_add_cell_ref(this.__wbg_ptr, r, _, t, n);
    let i;
    return o[0] !== 0 && (i = m(o[0], o[1]).slice(), c.__wbindgen_free(o[0], o[1] * 1, 1)), i;
  }
  add_cell_ref_with_transform(e, t) {
    const n = g(e, c.__wbindgen_malloc, c.__wbindgen_realloc), r = b, _ = B(t, c.__wbindgen_malloc), o = b, i = c.wasmlibrary_add_cell_ref_with_transform(this.__wbg_ptr, n, r, _, o);
    let f;
    return i[0] !== 0 && (f = m(i[0], i[1]).slice(), c.__wbindgen_free(i[0], i[1] * 1, 1)), f;
  }
  add_polygon(e, t, n) {
    const r = B(e, c.__wbindgen_malloc), _ = b, o = c.wasmlibrary_add_polygon(this.__wbg_ptr, r, _, t, n);
    let i;
    return o[0] !== 0 && (i = m(o[0], o[1]).slice(), c.__wbindgen_free(o[0], o[1] * 1, 1)), i;
  }
  add_rectangle(e, t, n, r, _, o) {
    const i = c.wasmlibrary_add_rectangle(this.__wbg_ptr, e, t, n, r, _, o);
    let f;
    return i[0] !== 0 && (f = m(i[0], i[1]).slice(), c.__wbindgen_free(i[0], i[1] * 1, 1)), f;
  }
  add_text(e, t, n, r, _, o) {
    const i = g(e, c.__wbindgen_malloc, c.__wbindgen_realloc), f = b, u = c.wasmlibrary_add_text(this.__wbg_ptr, i, f, t, n, r, _, o);
    let s;
    return u[0] !== 0 && (s = m(u[0], u[1]).slice(), c.__wbindgen_free(u[0], u[1] * 1, 1)), s;
  }
  boolean_operation(e, t, n) {
    const r = F(e, c.__wbindgen_malloc), _ = b, o = g(t, c.__wbindgen_malloc, c.__wbindgen_realloc), i = b, f = g(n, c.__wbindgen_malloc, c.__wbindgen_realloc), u = b, s = c.wasmlibrary_boolean_operation(this.__wbg_ptr, r, _, o, i, f, u);
    var y = A(s[0], s[1]).slice();
    return c.__wbindgen_free(s[0], s[1] * 4, 4), y;
  }
  can_instance_cell(e, t) {
    const n = g(e, c.__wbindgen_malloc, c.__wbindgen_realloc), r = b, _ = g(t, c.__wbindgen_malloc, c.__wbindgen_realloc), o = b;
    return c.wasmlibrary_can_instance_cell(this.__wbg_ptr, n, r, _, o) !== 0;
  }
  cell_count() {
    return c.wasmlibrary_cell_count(this.__wbg_ptr) >>> 0;
  }
  clear_active_cell() {
    c.wasmlibrary_clear_active_cell(this.__wbg_ptr);
  }
  create_path(e, t, n, r) {
    const _ = B(e, c.__wbindgen_malloc), o = b, i = c.wasmlibrary_create_path(this.__wbg_ptr, _, o, t, n, r);
    let f;
    return i[0] !== 0 && (f = m(i[0], i[1]).slice(), c.__wbindgen_free(i[0], i[1] * 1, 1)), f;
  }
  create_path_rounded(e, t, n, r, _, o) {
    const i = B(e, c.__wbindgen_malloc), f = b, u = c.wasmlibrary_create_path_rounded(this.__wbg_ptr, i, f, t, n, r, _, o);
    let s;
    return u[0] !== 0 && (s = m(u[0], u[1]).slice(), c.__wbindgen_free(u[0], u[1] * 1, 1)), s;
  }
  element_count() {
    return c.wasmlibrary_element_count(this.__wbg_ptr) >>> 0;
  }
  static from_gds_bytes(e) {
    const t = Se(e, c.__wbindgen_malloc), n = b, r = c.wasmlibrary_from_gds_bytes(t, n);
    if (r[2]) throw v(r[1]);
    return P.__wrap(r[0]);
  }
  static from_json(e) {
    const t = g(e, c.__wbindgen_malloc, c.__wbindgen_realloc), n = b, r = c.wasmlibrary_from_json(t, n);
    if (r[2]) throw v(r[1]);
    return P.__wrap(r[0]);
  }
  static from_library_json(e) {
    const t = g(e, c.__wbindgen_malloc, c.__wbindgen_realloc), n = b, r = c.wasmlibrary_from_library_json(t, n);
    if (r[2]) throw v(r[1]);
    return P.__wrap(r[0]);
  }
  get_all_bounds() {
    const e = c.wasmlibrary_get_all_bounds(this.__wbg_ptr);
    let t;
    return e[0] !== 0 && (t = S(e[0], e[1]).slice(), c.__wbindgen_free(e[0], e[1] * 8, 8)), t;
  }
  get_all_ids() {
    const e = c.wasmlibrary_get_all_ids(this.__wbg_ptr);
    var t = A(e[0], e[1]).slice();
    return c.__wbindgen_free(e[0], e[1] * 4, 4), t;
  }
  get_all_vertices() {
    const e = c.wasmlibrary_get_all_vertices(this.__wbg_ptr);
    var t = S(e[0], e[1]).slice();
    return c.__wbindgen_free(e[0], e[1] * 8, 8), t;
  }
  get_bounds_for_ids(e) {
    const t = F(e, c.__wbindgen_malloc), n = b, r = c.wasmlibrary_get_bounds_for_ids(this.__wbg_ptr, t, n);
    let _;
    return r[0] !== 0 && (_ = S(r[0], r[1]).slice(), c.__wbindgen_free(r[0], r[1] * 8, 8)), _;
  }
  get_cell_bounds(e) {
    const t = g(e, c.__wbindgen_malloc, c.__wbindgen_realloc), n = b, r = c.wasmlibrary_get_cell_bounds(this.__wbg_ptr, t, n);
    let _;
    return r[0] !== 0 && (_ = S(r[0], r[1]).slice(), c.__wbindgen_free(r[0], r[1] * 8, 8)), _;
  }
  get_cell_origin() {
    const e = c.wasmlibrary_get_cell_origin(this.__wbg_ptr);
    let t;
    return e[0] !== 0 && (t = S(e[0], e[1]).slice(), c.__wbindgen_free(e[0], e[1] * 8, 8)), t;
  }
  get_cell_origin_by_name(e) {
    const t = g(e, c.__wbindgen_malloc, c.__wbindgen_realloc), n = b, r = c.wasmlibrary_get_cell_origin_by_name(this.__wbg_ptr, t, n);
    let _;
    return r[0] !== 0 && (_ = S(r[0], r[1]).slice(), c.__wbindgen_free(r[0], r[1] * 8, 8)), _;
  }
  get_cell_preview_polygons(e, t, n) {
    const r = g(e, c.__wbindgen_malloc, c.__wbindgen_realloc), _ = b;
    return c.wasmlibrary_get_cell_preview_polygons(this.__wbg_ptr, r, _, t, n);
  }
  get_cell_ref_array(e) {
    const t = g(e, c.__wbindgen_malloc, c.__wbindgen_realloc), n = b, r = c.wasmlibrary_get_cell_ref_array(this.__wbg_ptr, t, n);
    let _;
    return r[0] !== 0 && (_ = S(r[0], r[1]).slice(), c.__wbindgen_free(r[0], r[1] * 8, 8)), _;
  }
  get_cell_ref_info(e) {
    const t = g(e, c.__wbindgen_malloc, c.__wbindgen_realloc), n = b, r = c.wasmlibrary_get_cell_ref_info(this.__wbg_ptr, t, n);
    return r === 0 ? void 0 : j.__wrap(r);
  }
  get_cell_tree() {
    return c.wasmlibrary_get_cell_tree(this.__wbg_ptr);
  }
  get_element_index(e) {
    const t = g(e, c.__wbindgen_malloc, c.__wbindgen_realloc), n = b;
    return c.wasmlibrary_get_element_index(this.__wbg_ptr, t, n);
  }
  get_element_info(e) {
    const t = g(e, c.__wbindgen_malloc, c.__wbindgen_realloc), n = b, r = c.wasmlibrary_get_element_info(this.__wbg_ptr, t, n);
    return r === 0 ? void 0 : z.__wrap(r);
  }
  get_element_vertices(e) {
    const t = g(e, c.__wbindgen_malloc, c.__wbindgen_realloc), n = b, r = c.wasmlibrary_get_element_vertices(this.__wbg_ptr, t, n);
    let _;
    return r[0] !== 0 && (_ = S(r[0], r[1]).slice(), c.__wbindgen_free(r[0], r[1] * 8, 8)), _;
  }
  get_elements_on_layer(e, t) {
    const n = c.wasmlibrary_get_elements_on_layer(this.__wbg_ptr, e, t);
    var r = A(n[0], n[1]).slice();
    return c.__wbindgen_free(n[0], n[1] * 4, 4), r;
  }
  get_group_ids(e) {
    const t = g(e, c.__wbindgen_malloc, c.__wbindgen_realloc), n = b, r = c.wasmlibrary_get_group_ids(this.__wbg_ptr, t, n);
    var _ = A(r[0], r[1]).slice();
    return c.__wbindgen_free(r[0], r[1] * 4, 4), _;
  }
  get_group_representative_ids() {
    const e = c.wasmlibrary_get_group_representative_ids(this.__wbg_ptr);
    var t = A(e[0], e[1]).slice();
    return c.__wbindgen_free(e[0], e[1] * 4, 4), t;
  }
  get_hidden_cells() {
    const e = c.wasmlibrary_get_hidden_cells(this.__wbg_ptr);
    var t = A(e[0], e[1]).slice();
    return c.__wbindgen_free(e[0], e[1] * 4, 4), t;
  }
  get_instance_label_data() {
    return c.wasmlibrary_get_instance_label_data(this.__wbg_ptr);
  }
  get_render_polygons() {
    const e = c.wasmlibrary_get_render_polygons(this.__wbg_ptr);
    if (e[2]) throw v(e[1]);
    return v(e[0]);
  }
  get_text_element_info(e) {
    const t = g(e, c.__wbindgen_malloc, c.__wbindgen_realloc), n = b;
    return c.wasmlibrary_get_text_element_info(this.__wbg_ptr, t, n);
  }
  get_text_labels() {
    return c.wasmlibrary_get_text_labels(this.__wbg_ptr);
  }
  get_used_layers() {
    const e = c.wasmlibrary_get_used_layers(this.__wbg_ptr);
    var t = I(e[0], e[1]).slice();
    return c.__wbindgen_free(e[0], e[1] * 4, 4), t;
  }
  hit_test(e, t) {
    const n = c.wasmlibrary_hit_test(this.__wbg_ptr, e, t);
    let r;
    return n[0] !== 0 && (r = m(n[0], n[1]).slice(), c.__wbindgen_free(n[0], n[1] * 1, 1)), r;
  }
  hit_test_rect(e, t, n, r) {
    const _ = c.wasmlibrary_hit_test_rect(this.__wbg_ptr, e, t, n, r);
    var o = A(_[0], _[1]).slice();
    return c.__wbindgen_free(_[0], _[1] * 4, 4), o;
  }
  is_cell_visible(e) {
    const t = g(e, c.__wbindgen_malloc, c.__wbindgen_realloc), n = b;
    return c.wasmlibrary_is_cell_visible(this.__wbg_ptr, t, n) !== 0;
  }
  is_dirty() {
    return c.wasmlibrary_is_dirty(this.__wbg_ptr) !== 0;
  }
  is_text_element(e) {
    const t = g(e, c.__wbindgen_malloc, c.__wbindgen_realloc), n = b;
    return c.wasmlibrary_is_text_element(this.__wbg_ptr, t, n) !== 0;
  }
  mark_clean() {
    c.wasmlibrary_mark_clean(this.__wbg_ptr);
  }
  constructor(e) {
    const t = g(e, c.__wbindgen_malloc, c.__wbindgen_realloc), n = b, r = c.wasmlibrary_new(t, n);
    return this.__wbg_ptr = r >>> 0, $.register(this, this.__wbg_ptr, this), this;
  }
  remove_cell(e) {
    const t = g(e, c.__wbindgen_malloc, c.__wbindgen_realloc), n = b;
    return c.wasmlibrary_remove_cell(this.__wbg_ptr, t, n) !== 0;
  }
  remove_element(e) {
    const t = g(e, c.__wbindgen_malloc, c.__wbindgen_realloc), n = b;
    return c.wasmlibrary_remove_element(this.__wbg_ptr, t, n) !== 0;
  }
  remove_elements(e) {
    const t = F(e, c.__wbindgen_malloc), n = b;
    return c.wasmlibrary_remove_elements(this.__wbg_ptr, t, n) >>> 0;
  }
  remove_elements_on_layer(e, t) {
    return c.wasmlibrary_remove_elements_on_layer(this.__wbg_ptr, e, t) >>> 0;
  }
  remove_layer_color(e, t) {
    c.wasmlibrary_remove_layer_color(this.__wbg_ptr, e, t);
  }
  rename_cell(e, t) {
    const n = g(e, c.__wbindgen_malloc, c.__wbindgen_realloc), r = b, _ = g(t, c.__wbindgen_malloc, c.__wbindgen_realloc), o = b, i = c.wasmlibrary_rename_cell(this.__wbg_ptr, n, r, _, o);
    if (i[2]) throw v(i[1]);
    return i[0] !== 0;
  }
  set_active_cell(e) {
    const t = g(e, c.__wbindgen_malloc, c.__wbindgen_realloc), n = b;
    return c.wasmlibrary_set_active_cell(this.__wbg_ptr, t, n) !== 0;
  }
  set_cell_origin(e, t) {
    return c.wasmlibrary_set_cell_origin(this.__wbg_ptr, e, t) !== 0;
  }
  set_cell_ref_array(e, t, n, r, _) {
    const o = g(e, c.__wbindgen_malloc, c.__wbindgen_realloc), i = b;
    return c.wasmlibrary_set_cell_ref_array(this.__wbg_ptr, o, i, t, n, r, _) !== 0;
  }
  set_cell_ref_transform(e, t) {
    const n = g(e, c.__wbindgen_malloc, c.__wbindgen_realloc), r = b, _ = B(t, c.__wbindgen_malloc), o = b;
    return c.wasmlibrary_set_cell_ref_transform(this.__wbg_ptr, n, r, _, o) !== 0;
  }
  set_cell_visibility(e, t) {
    const n = g(e, c.__wbindgen_malloc, c.__wbindgen_realloc), r = b;
    c.wasmlibrary_set_cell_visibility(this.__wbg_ptr, n, r, t);
  }
  set_hierarchy_depth_limit(e) {
    c.wasmlibrary_set_hierarchy_depth_limit(this.__wbg_ptr, e);
  }
  set_layer_color(e, t, n, r, _, o) {
    c.wasmlibrary_set_layer_color(this.__wbg_ptr, e, t, n, r, _, o);
  }
  set_layer_fill_pattern(e, t, n) {
    c.wasmlibrary_set_layer_fill_pattern(this.__wbg_ptr, e, t, n);
  }
  set_text_height(e, t) {
    const n = g(e, c.__wbindgen_malloc, c.__wbindgen_realloc), r = b;
    return c.wasmlibrary_set_text_height(this.__wbg_ptr, n, r, t) !== 0;
  }
  set_text_position(e, t, n) {
    const r = g(e, c.__wbindgen_malloc, c.__wbindgen_realloc), _ = b;
    return c.wasmlibrary_set_text_position(this.__wbg_ptr, r, _, t, n) !== 0;
  }
  to_gds() {
    const e = c.wasmlibrary_to_gds(this.__wbg_ptr);
    if (e[3]) throw v(e[2]);
    var t = E(e[0], e[1]).slice();
    return c.__wbindgen_free(e[0], e[1] * 1, 1), t;
  }
  to_json() {
    let e, t;
    try {
      const _ = c.wasmlibrary_to_json(this.__wbg_ptr);
      var n = _[0], r = _[1];
      if (_[3]) throw n = 0, r = 0, v(_[2]);
  ...
  to_library_json() {
    let e, t;
    try {
      const _ = c.wasmlibrary_to_library_json(this.__wbg_ptr);
      var n = _[0], r = _[1];
      if (_[3]) throw n = 0, r = 0, v(_[2]);
      return e = n, t = r, m(n, r);
    } finally {
  ...
  translate_element(e, t, n) {
    const r = g(e, c.__wbindgen_malloc, c.__wbindgen_realloc), _ = b;
    return c.wasmlibrary_translate_element(this.__wbg_ptr, r, _, t, n) !== 0;
  }
  translate_elements(e, t, n) {
    const r = F(e, c.__wbindgen_malloc), _ = b;
    return c.wasmlibrary_translate_elements(this.__wbg_ptr, r, _, t, n) >>> 0;
  }
  update_text(e, t) {
    const n = g(e, c.__wbindgen_malloc, c.__wbindgen_realloc), r = b, _ = g(t, c.__wbindgen_malloc, c.__wbindgen_realloc), o = b;
    return c.wasmlibrary_update_text(this.__wbg_ptr, n, r, _, o) !== 0;
  }
}
...
class q {
  ...
  free() {
    const e = this.__destroy_into_raw();
    c.__wbg_wasmrenderer_free(e, 0);
  }
  add_shape(e, t, n) {
    const r = g(e, c.__wbindgen_malloc, c.__wbindgen_realloc), _ = b, o = B(t, c.__wbindgen_malloc), i = b, f = H(n, c.__wbindgen_malloc), u = b;
    c.wasmrenderer_add_shape(this.__wbg_ptr, r, _, o, i, f, u);
  }
  add_to_selection(e) {
    const t = g(e, c.__wbindgen_malloc, c.__wbindgen_realloc), n = b;
    c.wasmrenderer_add_to_selection(this.__wbg_ptr, t, n);
  }
  capture_screenshot() {
    return c.wasmrenderer_capture_screenshot(this.__wbg_ptr);
  }
  clear_laser() {
    c.wasmrenderer_clear_laser(this.__wbg_ptr);
  }
  clear_preview() {
    c.wasmrenderer_clear_preview(this.__wbg_ptr);
  }
  clear_selection() {
    c.wasmrenderer_clear_selection(this.__wbg_ptr);
  }
  clear_shapes() {
    c.wasmrenderer_clear_shapes(this.__wbg_ptr);
  }
  static create(e) {
    const t = g(e, c.__wbindgen_malloc, c.__wbindgen_realloc), n = b;
    return c.wasmrenderer_create(t, n);
  }
  destroy() {
    c.wasmrenderer_destroy(this.__wbg_ptr);
  }
  get_hover() {
    const e = c.wasmrenderer_get_hover(this.__wbg_ptr);
    let t;
    return e[0] !== 0 && (t = m(e[0], e[1]).slice(), c.__wbindgen_free(e[0], e[1] * 1, 1)), t;
  }
  get_hover_ids() {
    const e = c.wasmrenderer_get_hover_ids(this.__wbg_ptr);
    var t = A(e[0], e[1]).slice();
    return c.__wbindgen_free(e[0], e[1] * 4, 4), t;
  }
  get_offset() {
    const e = c.wasmrenderer_get_offset(this.__wbg_ptr);
    var t = S(e[0], e[1]).slice();
    return c.__wbindgen_free(e[0], e[1] * 8, 8), t;
  }
  get_selection() {
    const e = c.wasmrenderer_get_selection(this.__wbg_ptr);
    var t = A(e[0], e[1]).slice();
    return c.__wbindgen_free(e[0], e[1] * 4, 4), t;
  }
  get_zoom() {
    return c.wasmrenderer_get_zoom(this.__wbg_ptr);
  }
  mark_dirty() {
    c.wasmrenderer_mark_dirty(this.__wbg_ptr);
  }
  remove_shape(e) {
    const t = g(e, c.__wbindgen_malloc, c.__wbindgen_realloc), n = b;
    c.wasmrenderer_remove_shape(this.__wbg_ptr, t, n);
  }
  render() {
    c.wasmrenderer_render(this.__wbg_ptr);
  }
  resize(e, t) {
    c.wasmrenderer_resize(this.__wbg_ptr, e, t);
  }
  screen_to_world(e, t) {
    const n = c.wasmrenderer_screen_to_world(this.__wbg_ptr, e, t);
    var r = S(n[0], n[1]).slice();
    return c.__wbindgen_free(n[0], n[1] * 8, 8), r;
  }
  set_crosshair_origin(e, t) {
    c.wasmrenderer_set_crosshair_origin(this.__wbg_ptr, e, t);
  }
  set_dpr(e) {
    c.wasmrenderer_set_dpr(this.__wbg_ptr, e);
  }
  set_grid_visible(e) {
    c.wasmrenderer_set_grid_visible(this.__wbg_ptr, e);
  }
  set_hover(e) {
    var t = d(e) ? 0 : g(e, c.__wbindgen_malloc, c.__wbindgen_realloc), n = b;
    c.wasmrenderer_set_hover(this.__wbg_ptr, t, n);
  }
  set_hover_color(e, t, n, r) {
    c.wasmrenderer_set_hover_color(this.__wbg_ptr, e, t, n, r);
  }
  set_hover_multiple(e) {
    const t = F(e, c.__wbindgen_malloc), n = b;
    c.wasmrenderer_set_hover_multiple(this.__wbg_ptr, t, n);
  }
  set_laser_opacity(e) {
    c.wasmrenderer_set_laser_opacity(this.__wbg_ptr, e);
  }
  set_laser_points(e) {
    const t = B(e, c.__wbindgen_malloc), n = b;
    c.wasmrenderer_set_laser_points(this.__wbg_ptr, t, n);
  }
  set_preview_origin(e, t, n, r) {
    const _ = H(r, c.__wbindgen_malloc), o = b;
    c.wasmrenderer_set_preview_origin(this.__wbg_ptr, e, t, n, _, o);
  }
  set_preview_shape(e, t) {
    const n = B(e, c.__wbindgen_malloc), r = b, _ = H(t, c.__wbindgen_malloc), o = b;
    c.wasmrenderer_set_preview_shape(this.__wbg_ptr, n, r, _, o);
  }
  set_selection(e) {
    const t = F(e, c.__wbindgen_malloc), n = b;
    c.wasmrenderer_set_selection(this.__wbg_ptr, t, n);
  }
  set_selection_color(e, t, n, r) {
    c.wasmrenderer_set_selection_color(this.__wbg_ptr, e, t, n, r);
  }
  set_theme(e) {
    c.wasmrenderer_set_theme(this.__wbg_ptr, e);
  }
  set_viewport(e, t, n) {
    c.wasmrenderer_set_viewport(this.__wbg_ptr, e, t, n);
  }
  shape_count() {
    return c.wasmrenderer_shape_count(this.__wbg_ptr) >>> 0;
  }
  sync_from_library(e) {
    ge(e, P), c.wasmrenderer_sync_from_library(this.__wbg_ptr, e.__wbg_ptr);
  }
  toggle_selection(e) {
    const t = g(e, c.__wbindgen_malloc, c.__wbindgen_realloc), n = b;
    c.wasmrenderer_toggle_selection(this.__wbg_ptr, t, n);
  }
  update_shape(e, t) {
    const n = g(e, c.__wbindgen_malloc, c.__wbindgen_realloc), r = b, _ = B(t, c.__wbindgen_malloc), o = b;
    c.wasmrenderer_update_shape(this.__wbg_ptr, n, r, _, o);
  }
}
...
function ne() {
  return { __proto__: null, "./rosette_wasm_bg.js": { __proto__: null, __wbg_String_8f0eb39a4a4c2f66: function(e, t) {
    const n = String(t), r = g(n, c.__wbindgen_malloc, c.__wbindgen_realloc), _ = b;
    p().setInt32(e + 4, _, true), p().setInt32(e + 0, r, true);
    ...
    const n = J(t), r = g(n, c.__wbindgen_malloc, c.__wbindgen_realloc), _ = b;
    p().setInt32(e + 4, _, true), p().setInt32(e + 0, r, true);
    ...
    p().setFloat64(e + 8, d(r) ? 0 : r, true), p().setInt32(e + 0, !d(r), true);
  }, __wbg___wbindgen_string_get_72fb696202c56729: function(e, t) {
    const n = t, r = typeof n == "string" ? n : void 0;
    var _ = d(r) ? 0 : g(r, c.__wbindgen_malloc, c.__wbindgen_realloc), o = b;
    p().setInt32(e + 4, o, true), p().setInt32(e + 0, _, true);
    ...
    e.blendFunc(t >>> 0, n >>> 0);
  }, __wbg_blitFramebuffer_d730a23ab4db248e: function(e, t, n, r, _, o, i, f, u, s, y) {
    e.blitFramebuffer(t, n, r, _, o, i, f, u, s >>> 0, y >>> 0);
    ...
    e.compileShader(t);
  }, __wbg_compressedTexSubImage2D_215bb115facd5e48: function(e, t, n, r, _, o, i, f, u) {
    e.compressedTexSubImage2D(t >>> 0, n, r, _, o, i, f >>> 0, u);
  }, __wbg_compressedTexSubImage2D_684350eb62830032: function(e, t, n, r, _, o, i, f, u) {
    e.compressedTexSubImage2D(t >>> 0, n, r, _, o, i, f >>> 0, u);
  }, __wbg_compressedTexSubImage2D_d8fbae93bb8c4cc9: function(e, t, n, r, _, o, i, f, u, s) {
    e.compressedTexSubImage2D(t >>> 0, n, r, _, o, i, f >>> 0, u, s);
  }, __wbg_compressedTexSubImage3D_16afa3a47bf1d979: function(e, t, n, r, _, o, i, f, u, s, y) {
    e.compressedTexSubImage3D(t >>> 0, n, r, _, o, i, f, u, s >>> 0, y);
  }, __wbg_compressedTexSubImage3D_778008a6293f15ab: function(e, t, n, r, _, o, i, f, u, s, y, x) {
    e.compressedTexSubImage3D(t >>> 0, n, r, _, o, i, f, u, s >>> 0, y, x);
  ...
  }, __wbg_copyTexSubImage2D_417a65926e3d2490: function(e, t, n, r, _, o, i, f, u) {
    e.copyTexSubImage2D(t >>> 0, n, r, _, o, i, f, u);
  }, __wbg_copyTexSubImage2D_91ebcd9cd1908265: function(e, t, n, r, _, o, i, f, u) {
    e.copyTexSubImage2D(t >>> 0, n, r, _, o, i, f, u);
  }, __wbg_copyTexSubImage3D_f62ef4c4eeb9a7dc: function(e, t, n, r, _, o, i, f, u, s) {
    e.copyTexSubImage3D(t >>> 0, n, r, _, o, i, f, u, s);
  ...
  }, __wbg_framebufferTextureMultiviewOVR_16d049b41d692b91: function(e, t, n, r, _, o, i) {
    e.framebufferTextureMultiviewOVR(t >>> 0, n >>> 0, r, _, o, i);
    ...
    const n = t.label, r = g(n, c.__wbindgen_malloc, c.__wbindgen_realloc), _ = b;
    p().setInt32(e + 4, _, true), p().setInt32(e + 0, r, true);
    ...
    const n = t.message, r = g(n, c.__wbindgen_malloc, c.__wbindgen_realloc), _ = b;
    p().setInt32(e + 4, _, true), p().setInt32(e + 0, r, true);
    ...
    return l(function(e, t, n, r, _, o, i, f) {
      e.readPixels(t, n, r, _, o >>> 0, i >>> 0, f);
    }, arguments);
    ...
    e.scissor(t, n, r, _);
  }, __wbg_setBindGroup_62a3045b0921e429: function(e, t, n, r, _, o, i) {
    e.setBindGroup(t >>> 0, n, I(r, _), o, i >>> 0);
  }, __wbg_setBindGroup_6c0fd18e9a53a945: function(e, t, n) {
    e.setBindGroup(t >>> 0, n);
  }, __wbg_setBindGroup_7f3b61f1f482133b: function(e, t, n) {
    e.setBindGroup(t >>> 0, n);
  }, __wbg_setBindGroup_bf767a5aa46a33ce: function(e, t, n, r, _, o, i) {
    e.setBindGroup(t >>> 0, n, I(r, _), o, i >>> 0);
  }, __wbg_setBindGroup_c4aaff14063226b4: function(e, t, n, r, _, o, i) {
    e.setBindGroup(t >>> 0, n, I(r, _), o, i >>> 0);
    ...
    e.setVertexBuffer(t >>> 0, n, r);
  }, __wbg_setViewport_731ad30abb13f744: function(e, t, n, r, _, o, i) {
    e.setViewport(t, n, r, _, o, i);
    ...
    const n = t.stack, r = g(n, c.__wbindgen_malloc, c.__wbindgen_realloc), _ = b;
    p().setInt32(e + 4, _, true), p().setInt32(e + 0, r, true);
    ...
    return l(function(e, t, n, r, _, o, i, f, u, s) {
      e.texImage2D(t >>> 0, n, r, _, o, i, f >>> 0, u >>> 0, s);
    }, arguments);
    ...
    return l(function(e, t, n, r, _, o, i, f, u, s, y) {
      e.texImage3D(t >>> 0, n, r, _, o, i, f, u >>> 0, s >>> 0, y);
    }, arguments);
  ...
  }, __wbg_texStorage3D_e9e1b58fee218abe: function(e, t, n, r, _, o, i) {
    e.texStorage3D(t >>> 0, n, r >>> 0, _, o, i);
  }, __wbg_texSubImage2D_117d29278542feb0: function() {
    return l(function(e, t, n, r, _, o, i, f, u, s) {
      e.texSubImage2D(t >>> 0, n, r, _, o, i, f >>> 0, u >>> 0, s);
    }, arguments);
    ...
    return l(function(e, t, n, r, _, o, i, f, u, s, y, x) {
      e.texSubImage3D(t >>> 0, n, r, _, o, i, f, u, s >>> 0, y >>> 0, x);
    }, arguments);
  ...
  }, __wbg_vertexAttribPointer_75f6ff47f6c9f8cb: function(e, t, n, r, _, o, i) {
    e.vertexAttribPointer(t >>> 0, n, r >>> 0, _ !== 0, o, i);
  }, __wbg_vertexAttribPointer_adbd1853cce679ad: function(e, t, n, r, _, o, i) {
    e.vertexAttribPointer(t >>> 0, n, r >>> 0, _ !== 0, o, i);
    ...
    return te(e, t, c.wasm_bindgen__closure__destroy__hd580dc64d670e909, oe);
  }, __wbindgen_cast_0000000000000002: function(e, t) {
    return te(e, t, c.wasm_bindgen__closure__destroy__hd9d8fcf544480c3e, ae);
...
function oe(a, e, t) {
  c.wasm_bindgen__convert__closures_____invoke__hc63a6cfd4bd96038(a, e, t);
}
function ae(a, e, t) {
  c.wasm_bindgen__convert__closures_____invoke__hfedee57f14a5ed81(a, e, t);
}
function ie(a, e, t, n) {
  c.wasm_bindgen__convert__closures_____invoke__hd55f58cd52f0a612(a, e, t, n);
}
const fe = ["error", "warning", "info"], be = ["unknown", "destroyed"], ue = ["validation", "out-of-memory", "internal"], Q = ["uint16", "uint32"], se = ["r8unorm", "r8snorm", "r8uint", "r8sint", "r16uint", "r16sint", "r16float", "rg8unorm", "rg8snorm", "rg8uint", "rg8sint", "r32uint", "r32sint", "r32float", "rg16uint", "rg16sint", "rg16float", "rgba8unorm", "rgba8unorm-srgb", "rgba8snorm", "rgba8uint", "rgba8sint", "bgra8unorm", "bgra8unorm-srgb", "rgb9e5ufloat", "rgb10a2uint", "rgb10a2unorm", "rg11b10ufloat", "rg32uint", "rg32sint", "rg32float", "rgba16uint", "rgba16sint", "rgba16float", "rgba32uint", "rgba32sint", "rgba32float", "stencil8", "depth16unorm", "depth24plus", "depth24plus-stencil8", "depth32float", "depth32float-stencil8", "bc1-rgba-unorm", "bc1-rgba-unorm-srgb", "bc2-rgba-unorm", "bc2-rgba-unorm-srgb", "bc3-rgba-unorm", "bc3-rgba-unorm-srgb", "bc4-r-unorm", "bc4-r-snorm", "bc5-rg-unorm", "bc5-rg-snorm", "bc6h-rgb-ufloat", "bc6h-rgb-float", "bc7-rgba-unorm", "bc7-rgba-unorm-srgb", "etc2-rgb8unorm", "etc2-rgb8unorm-srgb", "etc2-rgb8a1unorm", "etc2-rgb8a1unorm-srgb", "etc2-rgba8unorm", "etc2-rgba8unorm-srgb", "eac-r11unorm", "eac-r11snorm", "eac-rg11unorm", "eac-rg11snorm", "astc-4x4-unorm", "astc-4x4-unorm-srgb", "astc-5x4-unorm", "astc-5x4-unorm-srgb", "astc-5x5-unorm", "astc-5x5-unorm-srgb", "astc-6x5-unorm", "astc-6x5-unorm-srgb", "astc-6x6-unorm", "astc-6x6-unorm-srgb", "astc-8x5-unorm", "astc-8x5-unorm-srgb", "astc-8x6-unorm", "astc-8x6-unorm-srgb", "astc-8x8-unorm", "astc-8x8-unorm-srgb", "astc-10x5-unorm", "astc-10x5-unorm-srgb", "astc-10x6-unorm", "astc-10x6-unorm-srgb", "astc-10x8-unorm", "astc-10x8-unorm-srgb", "astc-10x10-unorm", "astc-10x10-unorm-srgb", "astc-12x10-unorm", "astc-12x10-unorm-srgb", "astc-12x12-unorm", "astc-12x12-unorm-srgb"], Y = typeof FinalizationRegistry > "u" ? { register: () => {
}, unregister: () => {
} } : new FinalizationRegistry((a) => c.__wbg_cellrefinfo_free(a >>> 0, 1)), Z = typeof FinalizationRegistry > "u" ? { register: () => {
}, unregister: () => {
} } : new FinalizationRegistry((a) => c.__wbg_elementinfo_free(a >>> 0, 1)), $ = typeof FinalizationRegistry > "u" ? { register: () => {
}, unregister: () => {
} } : new FinalizationRegistry((a) => c.__wbg_wasmlibrary_free(a >>> 0, 1)), K = typeof FinalizationRegistry > "u" ? { register: () => {
}, unregister: () => {
} } : new FinalizationRegistry((a) => c.__wbg_wasmrenderer_free(a >>> 0, 1));
function w(a) {
  const e = c.__externref_table_alloc();
  return c.__wbindgen_externrefs.set(e, a), e;
}
function ge(a, e) {
...
function A(a, e) {
  a = a >>> 0;
  const t = p(), n = [];
  for (let r = a; r < a + 4 * e; r += 4) n.push(c.__wbindgen_externrefs.get(t.getUint32(r, true)));
  return c.__externref_drop_slice(a, e), n;
}
function we(a, e) {
...
let R = null;
function re() {
  return (R === null || R.byteLength === 0) && (R = new Float32Array(c.memory.buffer)), R;
}
let k = null;
function _e() {
...
let L = null;
function me() {
  return (L === null || L.byteLength === 0) && (L = new Int16Array(c.memory.buffer)), L;
}
let C = null;
function pe() {
  return (C === null || C.byteLength === 0) && (C = new Int32Array(c.memory.buffer)), C;
}
let W = null;
function ye() {
  return (W === null || W.byteLength === 0) && (W = new Int8Array(c.memory.buffer)), W;
}
function m(a, e) {
  return a = a >>> 0, Ie(a, e);
}
let O = null;
function he() {
  return (O === null || O.byteLength === 0) && (O = new Uint16Array(c.memory.buffer)), O;
}
let G = null;
function xe() {
  return (G === null || G.byteLength === 0) && (G = new Uint32Array(c.memory.buffer)), G;
}
let V = null;
function M() {
...
function te(a, e, t, n) {
  const r = { a, b: e, cnt: 1, dtor: t }, _ = (...o) => {
    r.cnt++;
    const i = r.a;
    r.a = 0;
    try {
...
function H(a, e) {
  ...
  return re().set(a, t / 4), b = a.length, t;
}
function B(a, e) {
  const t = e(a.length * 8, 8) >>> 0;
  return _e().set(a, t / 8), b = a.length, t;
}
function F(a, e) {
  const t = e(a.length * 4, 4) >>> 0;
...
function g(a, e, t) {
  if (t === void 0) {
    const i = U.encode(a), f = e(i.length, 1) >>> 0;
    return M().subarray(f, f + i.length).set(i), b = i.length, f;
  }
  ...
  if (o !== n) {
    ...
    const i = M().subarray(r + o, r + n), f = U.encodeInto(a, i);
    o += f.written, r = t(r, n, o, 1) >>> 0;
  }
  return b = o, r;
}
function v(a) {
  const e = c.__wbindgen_externrefs.get(a);
  return c.__externref_table_dealloc(a), e;
}
...
let X = 0;
function Ie(a, e) {
  return X += e, X >= ve && (N = new TextDecoder("utf-8", { ignoreBOM: true, fatal: true }), N.decode(), X = e), N.decode(M().subarray(a, a + e));
}
...
let b = 0, c;
function ce(a, e) {
  return c = a.exports, T = null, R = null, k = null, L = null, C = null, W = null, O = null, G = null, V = null, c.__wbindgen_start(), c;
}
...
async function Pe(a) {
  if (c !== void 0) return c;
  a !== void 0 && (Object.getPrototypeOf(a) === Object.prototype ? { module_or_path: a } = a : console.warn("using deprecated parameters for the initialization function; pass a single object instead")), a === void 0 && (a = new URL("" + new URL("rosette_wasm_bg-DrEE7v2j.wasm", import.meta.url).href, import.meta.url));
  const e = ne();
