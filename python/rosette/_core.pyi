...
class ChecksResult:
    ...
    @property
    def connectivity_nodes(self) -> int: ...
    @property
    def ports_uncheckable(self) -> int: ...
    @property
    def hierarchy_issues(self) -> int: ...
    @property
    def bends_checked(self) -> int: ...
    @property
    def bends_uncheckable(self) -> int: ...
    @property
    def route_annotation_cells_checked(self) -> int: ...
    @property
    def route_annotation_cells_missing(self) -> int: ...
    @property
    def elapsed_ms(self) -> float: ...
    def __len__(self) -> int: ...
